...
% \setbeamercolor{banner}{bg=white,fg=black}

%%% Add a stripe behind the banner
\setbeamercolor{banner stripe}{bg=psu-sand,fg=psu-white}
...
\setbeamercolor{background canvas}{bg=psu-sand}
...
\setbeamertemplate{banner}[psu]
% \setbeamercolor{banner}{bg=psu-sand}
% \setbeamercolor{banner stripe}{bg=psu-sand,fg=psu-black}
